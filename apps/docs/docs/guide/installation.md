...
After installation, configure the CLI using the generated config file at:

```bash
~/.config/devkitcli/devkit
```

This file stores your personal and project-level credentials:

- `GIT_USER`, `BUF_USER`, `DOCKER_HUB_USER`
- `GITHUB_TOKEN` (must have repo creation permissions)
- `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET`
- `RESEND_API_KEY`
- `API_SERVICE_NAME`, `API_VERSION`

> 🔐 Keep this file secure — it contains secrets used by the CLI.
