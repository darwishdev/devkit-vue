/**
  ...
  *
  * @checksum - 7c612df3baa90c5c9eb663041a4bd92d2b7211858415e2269f7039367a0f05e7
  * @variables - radius=rounded,accentColor=blue,colorTemperature=slate,spacing=1.5,scale=sm,inputShadow=shadow-sm,baseColorShade=600,borderShadeLightMode=100,borderShadeDarkMode=700,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
