...
import type { StringUnknownRecord, AuthLoginProviderCallbackRequest, AuthLoginProviderRequest, AuthLoginProviderResponse, AuthLoginRequest, AuthLoginResponse, AuthResetPasswordEmailRequest, AuthResetPasswordEmailResponse, AuthResetPasswordRequest, AuthResetPasswordResponse, BucketCreateUpdateRequest, BucketCreateUpdateResponse, BucketListRequest, BucketListResponse, DeleteRequest,  FileUploadUrlFindRequest, FileUploadUrlFindResponse, GalleryListRequest, GalleryListResponse } from './api_types'
...
> = {
	...
	callback?: TFindResponsePropName extends string ? (formResp: Record<TFindResponsePropName, TFormRequest>) => TFindCallbakResponse : (formResp: TFormRequest) => TFindCallbakResponse
}
