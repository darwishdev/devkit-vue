...
export type OptionGetterParams<TApi extends Record<string, Function>, TOptionsReq extends StringUnknownRecord, TOptionsResp extends StringUnknownRecord> = Pick<DropdownContext<TApi, TOptionsReq, TOptionsResp>, 'responseOptionsKey' | 'optionsMapper' | 'options' | 'bypassCache'> & {
	request?: TOptionsReq,
	apiClient?: TApi
}
...
export const fetchDropdownOptions =
	<TApi extends Record<string, Function>, TOptionsReq extends StringUnknownRecord, TOptionsResp extends StringUnknownRecord>({
		options,
		optionsMapper,
		apiClient,
...
export const useDebouncedOptionsFetcher = <TApi extends Record<string, Function>, TOptionsReq extends StringUnknownRecord, TOptionsResp extends StringUnknownRecord>() => {
...
export const fetchCachedDropdownOptions = <TApi extends Record<string, Function>, TOptionsReq extends StringUnknownRecord, TOptionsResp extends StringUnknownRecord>(
...
export const useMemoizedDropdownOptions = <TApi extends Record<string, Function>, TOptionsReq extends StringUnknownRecord, TOptionsResp extends StringUnknownRecord>() => {
