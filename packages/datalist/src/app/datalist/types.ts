...
export type DatalistMappers<TReq extends StringUnknownRecord, TRecord extends StringUnknownRecord> = {
...
export type DatalistRecords<TApi extends Record<string, Function>, TReq extends StringUnknownRecord, TRecord extends StringUnknownRecord, TFiltersReq extends StringUnknownRecord | undefined = undefined, TApiResponse extends StringUnknownRecord | undefined = undefined> = TRecord[] | ApiEndpoint<
	TApi,
...
export type DatalistColumnBase<TRecord extends Record<string, unknown>, TFiltersReq extends StringUnknownRecord | undefined = undefined> = {
	props?: ColumnProps
	slots?: ColumnSlots
...
export type DatalistColumnClientSide<TRecord extends Record<string, unknown>, TFiltersReq extends StringUnknownRecord | undefined = undefined> = DatalistColumnBase<TRecord, TFiltersReq> & {
	filters?: DatalistFilter<TFiltersReq>[]
}
export type DatalistColumnServerSide<TRecord extends Record<string, unknown>, TFiltersReq extends StringUnknownRecord | undefined = undefined> = DatalistColumnBase<TRecord, TFiltersReq> & {
	filters?: DatalistFilterInput<TFiltersReq>[]
}


export type DatalistColumnsClientSide<TRecord extends StringUnknownRecord, TFiltersReq extends StringUnknownRecord | undefined = undefined> = Partial<Record<keyof TRecord, DatalistColumnClientSide<TRecord, TFiltersReq>>>
export type DatalistColumnsServerSide<TRecord extends StringUnknownRecord, TFiltersReq extends StringUnknownRecord | undefined = undefined> = Partial<Record<keyof TRecord, DatalistColumnServerSide<TRecord, TFiltersReq>>>
export type DatalistColumnsBase<TRecord extends StringUnknownRecord, TFiltersReq extends StringUnknownRecord | undefined = undefined> = Partial<Record<keyof TRecord, DatalistColumnBase<TRecord, TFiltersReq>>>
